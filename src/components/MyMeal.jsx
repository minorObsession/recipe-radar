...
function MyMeal({ recipes, i }) {
  ...
  return (
    // ! EACH DAY GRID
    <div
      className={`grid grid-cols-[2fr_3fr] grid-rows-[1fr_3fr] gap-2 bg-stone-600 p-2 rounded-xl `}
    >
      {/* // !  */}
      <div className="col-span-2 flex items-center gap-5 justify-between ">
        <h3
      ...
      {!isCollapsed && (
        <img
          ...
          className="col-[2_/1] text-center rounded-2xl "
        ></img>
      )}
      {daysPlannedOrNot[i] ? (
        <div
